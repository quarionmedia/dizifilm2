...
<style>
    /* Styling for the cast list and image previews */
    ...
    .image-previews { display: flex; flex-direction: column; gap: 20px; align-items: flex-start; } /* Dikey hizalama için güncellendi */
    .preview-box { width: 200px; }
    .preview-box h4 { margin-top: 0; margin-bottom: 5px;}
    .logo-preview-bg { background-color: #333; padding: 10px; border-radius: 5px; }
</style>
